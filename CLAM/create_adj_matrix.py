...
def pt2graph(wsi_h5, radius=9):
    ...
    G = geomData(edge_index = edge_spatial,
...
h5_path = '/data4/doanhbc/camelyon_patches_20x/features/h5_files'
save_path = '/data4/doanhbc/camelyon_patches_20x/features/graph_files'
