...
def collate_MIL(batch):
	...
	# coords = torch.cat([item[3] for item in batch], dim = 0) # coords
	# multi_adj = [item[4] for item in batch]
	return [img, label]
...
def get_optim(model, args):
	...
	# 	# base_optim = RAdam(model.parameters(),lr = 0.0002, weight_decay = 0.00001) 
